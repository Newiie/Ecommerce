...
const Cart = () => {
  const { userId, cartData, products, setCartData, setProducts, SubTotalPrice, setSubtotalPrice, totalPrice, setTotalPrice } = useApp();
  ...
  useEffect(() => {
    ...
    const getCartData = async () => {
      try {
        ...
        if (response.data && response.data.cartData) {
          console.log("RESPONSE CARTDATA ", response.data.cartData);
    ...
    getCartData();
  }, [userId, navigate, setCartData, setSubtotalPrice, setTotalPrice]);
